...
class RoomAvailabilityPage:
    def __init__(self, root):
        ...
        # Initial update of room availability
    ...
    def update_availability(self):
        ...
        for room_number in range(101, 201):
            ...
            room_label = Label(self.results_frame, text=f"🚪{room_number}", font=('Times', 15), fg=color, bg="#c9c1a7")
            room_label.grid(row=row_num, column=col_num, padx=5, pady=5)
